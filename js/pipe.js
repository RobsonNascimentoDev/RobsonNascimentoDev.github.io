...
AFRAME.registerComponent("pipe", {
  ...
  init: function() {
    ...
    bBox1.setAttribute("color", "#000000");
    bBox2.setAttribute("color", "#000000");

    bRing1.setAttribute("color", "#4C1130");
    bRing2.setAttribute("color", "#4C1130");
    
    bCyl1.setAttribute("color", "#990000");
    bCyl2.setAttribute("color", "#990000");
    
    tBox1.setAttribute("color", "#000000");
    tBox2.setAttribute("color", "#000000");

    tRing1.setAttribute("color", "#4C1130");
    tRing2.setAttribute("color", "#4C1130");
    
    tCyl1.setAttribute("color", "#990000");
    tCyl2.setAttribute("color", "#990000");
